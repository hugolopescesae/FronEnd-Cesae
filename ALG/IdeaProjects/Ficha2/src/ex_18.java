...
public class ex_18 {
    public static void main(String[] args) {
        ...
        // Ler dias e código de utilizador
        ...
        if (cargo.equals("empregado") && ((diastrabalho*5)+(diastrabalho*40)<=1000)){
            ...
            if (cargo.equals("empregado") && ((diastrabalho*5)+(diastrabalho*40)>=1000)){
                ...
                if (cargo.equals("chefe") && ((diastrabalho*7.5)+(diastrabalho*60)<=1000)){
                    ...
                    if (cargo.equals("chefe") && ((diastrabalho*7.5)+(diastrabalho*60)>=1000)){
                        ...
                        if (cargo.equals("administrador") && ((diastrabalho*7.5)+(diastrabalho*80)<=1000)){
        ...
        switch (cargo){
            case "empregado" : if (((diastrabalho*5)+(diastrabalho*40)<=1000)){
            ...
            case "chefe" : if (((diastrabalho*7.5)+(diastrabalho*60)<=1000)){
            ...
            case "administrador" : if (((diastrabalho*7.5)+(diastrabalho*80)<=1000)){
