    ...
    public static void main(String[] args) {
        ...
        do {
            do {
                ...
                System.out.println("Pretende corrigir o código de funcionário?(s/n)");
                corrigir = input.next();
            }while (corrigir.equals(("s")));
            do {
                System.out.print("Introduza o número de dias de trabalho: ");
                numDias = input.nextInt();
                System.out.println("Pretende corrigir os dias de trabalho?(s/n)");
                corrigir = input.next();
                if (numDias > 31) {
                ...
                do {
                    ...
                    if (cargo.equals("empregado") || cargo.equals("chefe") || cargo.equals("administrador")) {
                        do {
                            ...
                            switch (aux) {
                                case 1:
                                    if (cargo.equals("empregado")) { // Valor íliquido (Base+Bónus) a receber fruto do vencimento!
                                        salario = 40 * numDias;
                                        if (numDias > 20) {
                                    ...
                                    break;
                                case 2:
                                    if (cargo.equals("empregado")) { // Valor total do Subsídio de Alimentação!
                                    ...
                                    break;
                                case 3:
                                    if (cargo.equals("empregado")) { // valor da retenção de IRS a entregar ao estado
                                        salario = numDias * 40;
                                        if (salario < 1000) {
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    if (cargo.equals("empregado")) { // Valor líquido a receber!
                                        salario = 40 * numDias;
                                        if (numDias > 20) {
                                            subali = numDias * 5;
                                    ...
                                    break;
                                case 6:
                                    if (cargo.equals("empregado")) { // Encargo total com salários, subsídios e impostos que a empresa terá!
                                        salario = 40 * numDias;
                                        subali = 5 * numDias;
                                        if (numDias > 20) {
                                            if (salario < 1000) {
